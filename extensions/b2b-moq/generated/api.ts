...
export type CartValidationsInputVariables = Exact<{ [key: string]: never; }>;


export type CartValidationsInput = { __typename?: 'Input', cart: { __typename?: 'Cart', buyerIdentity?: { __typename?: 'BuyerIdentity', isAuthenticated: boolean, customer?: { __typename?: 'Customer', tagWholesale: boolean, tagB2b: boolean, tagB2bVip: boolean, tagReseller: boolean, tagDistributor: boolean, tagTrade: boolean, tagVip: boolean, tagBulk: boolean } | null } | null, lines: Array<{ __typename?: 'CartLine', id: string, quantity: number, merchandise: { __typename: 'CustomProduct' } | { __typename: 'ProductVariant', id: string, product: { __typename?: 'Product', id: string, inCollections: Array<{ __typename?: 'CollectionMembership', collectionId: string }> } } }> }, shop: { __typename?: 'Shop', metafield?: { __typename?: 'Metafield', jsonValue: any } | null } };
